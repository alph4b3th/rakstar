...
extern bool onPlayerText(int playerid, char *text);
extern bool onPlayerCommandText(int playerid, char *cmdtext);
...
extern bool onRconCommand(char *cmd);
...
extern bool onVehicleRespray(int playerid, int vehicleid, int color1,
                             int color2);
extern bool onVehicleDamageStatusUpdate(int vehicleid, int playerid);

extern bool onUnoccupiedVehicleUpdate(int vehicleid, int playerid,
                                      int passenger_seat, float new_x,
                                      float new_y, float new_z, float vel_x,
...
extern bool onPlayerInteriorChange(int playerid, int newinteriorid,
                                   int oldinteriorid);

extern bool onPlayerKeyStateChange(int playerid, int newkeys, int oldkeys);
extern bool onRconLoginAttempt(char *ip, char *password, bool success);
...
extern bool onDialogResponse(int playerid, int dialogid, int response,
                             int listitem, char *inputtext);

extern bool onPlayerTakeDamage(int playerid, int issuerid, float amount,
                               int weaponid, int bodypart);
extern bool onPlayerGiveDamage(int playerid, int damagedid, float amount,
                               int weaponid, int bodypart);

extern bool onPlayerGiveDamageActor(int playerid, int damaged_actorid,
...
extern bool onIncomingConnection(int playerid, char *ip_address, int port);
extern bool onTrailerUpdate(int playerid, int vehicleid);

extern bool onVehicleSirenStateChange(int playerid, int vehicleid,
                                      int newstate);
extern bool onPlayerClickPlayer(int playerid, int clickedplayerid, int source);

extern bool onPlayerEditObject(int playerid, bool playerobject, int objectid,
                               int response, float fX, float fY, float fZ,
                               float fRotX, float fRotY, float fRotZ);
extern bool onPlayerEditAttachedObject(int playerid, int response, int index,
                                       int modelid, int boneid, float fOffsetX,
                                       float fOffsetY, float fOffsetZ,
                                       float fRotX, float fRotY, float fRotZ,
                                       float fScaleX, float fScaleY,
                                       float fScaleZ);

extern bool onPlayerSelectObject(int playerid, int type, int objectid,
                                 int modelid, float fX, float fY, float fZ);
extern bool onPlayerWeaponShot(int playerid, int weaponid, int hittype,
                               int hitid, float fX, float fY, float fZ);
